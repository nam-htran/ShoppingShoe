    ...
    <div class="flex">
      ...
      <div class="w-1/5 bg-white h-screen shadow-md">
        <div class="p-4 flex items-center">
          <img alt="Logo" class="mr-2" height="50" src="https://storage.googleapis.com/a1aa/image/IDfXzoHoR3xgbaxiiS56aXrMkUNe1TloHaGupdYCuVXmfwxnA.jpg" width="50" />
          <span class="text-2xl font-bold text-green-700">ADMIN MANAGEMENT</span>
        </div>
        <ul class="mt-4">
          <li class="p-4 hover:bg-gray-200 cursor-pointer"><a href="${pageContext.request.contextPath}/admin_customer_management" class="block">Customer Manage</a></li>
          ...
          <li class="p-4 hover:bg-gray-200 cursor-pointer"><a href="${pageContext.request.contextPath}/admin_report" class="block">Report</a></li>
