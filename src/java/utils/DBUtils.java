...
public class DBUtils {
    ...
    public static Connection getConnection(){
        ...
        try {
            ...
            System.out.println("ASM: Can not load JDBC Driver. Please check your pom file");
        }
        ...
        try {
            ...
            System.out.println("ASM: Can not connect SQL Server. Reason: " + ex.getMessage());                        
        }
        return null;
    }
    ...
    private final static String dbName = "TuanShoes";
